      ...
      <div className="shadow shadow-gray-400 bg-opacity-45 outline-2 space-y-2 p-4 bg-gray-600 rounded-3xl">
        ...
        <div className="flex items-center justify-between text-sm">
          <div className="gap-2 flex items-center relative">
            <Image
              src="/public/swap/slippage.svg" // Replace with the actual path
              alt="Crypto Swap"
              width={20}
              height={20}
            />
            ...
            {/* Slippage Modal */}
            {showSlippageModal && (
              <div className="absolute top-6 left-10 z-20 w-72 p-3 bg-gray-700 rounded-md text-xs text-white shadow-lg">
        ...
        <div className="flex items-center justify-between">
          <div className="flex gap-1 items-center relative">
            <Image
              src="/public/swap/star.svg" // Replace with actual path
              alt="Degen Mode"
              width={20}
              height={20}
            />
            ...
            {showDegenModal && (
              <div className="absolute top-6 left-10 z-20 w-72 p-3 bg-gray-700 rounded-md text-xs text-white shadow-lg">
                Degen mode allows for riskier trades with less slippage protection, increasing the likelihood of trade success.
              </div>
            )}
          </div>
